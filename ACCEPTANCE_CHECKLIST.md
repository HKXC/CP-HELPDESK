...
| 2 | สร้าง Repair Request ใหม่ | บันทึกสำเร็จ ได้เลขที่ใบงาน (unique ID) | ✅ ผ่าน | API: POST 201 ได้เลข HD-… (smoke 2026-09-15) |
...
| 6 | แนบไฟล์ในใบงานตัวเอง ขนาด < 10MB | อัปโหลดสำเร็จ แสดงตัวอย่าง/ลิงก์ไฟล์ | ✅ ผ่าน | API: upload 201 + download 200 เนื้อหาตรง (UI preview รอคลิก) |
