...
> อัปเดต: 2026-09-14 • อ่านจากโค้ดจริงใน `helpdesk/src` + `prisma/` + `CHANGELOG.md`
...
1. Neon `DATABASE_URL` + `DIRECT_URL` + `BLOB_READ_WRITE_TOKEN` ยังไม่ได้จากผู้ใช้ + ยังไม่ push GitHub (F4)
